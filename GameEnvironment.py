...
class Game:
     ...
     def shuffle_cards(game):
         ...
         for i in range(0,51):
             ...
             temp = shuffled_deck[num]
             temp2 = shuffled_deck[i]
             shuffled_deck[i] = temp
             shuffled_deck[num] = temp2
         return shuffled_deck #replace this with random.shuffle()
...
Go_Fish = Game(3)
Go_Fish.shuffled_deck = Go_Fish.shuffle_cards()
